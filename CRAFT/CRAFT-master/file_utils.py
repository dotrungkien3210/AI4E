        ...
        with open(res_file, 'w') as f:
            for i, box in enumerate(boxes):
                ...
                try:
                    ...
                    cv2.imwrite(
                        file_name + '_{}_{}_{}_{}_{}_{}_{}_{}.jpg'.format(xmin, ymax, xmax, ymax, xmax, ymin, xmin, ymin), word)
                    print('Image saved to ' + file_name + '_{}_{}_{}_{}_{}_{}_{}_{}.jpg'.format(xmin, ymax, xmax, ymax, xmax,
                                                                                                ymin, xmin, ymin))
                except:
                    continue
                print('-----------------------------------------------------------------')
                ...
                if texts is not None:
                    ...
                    cv2.putText(img, "{:.2f}".format(texts[i]), tuple(poly[0]), font, font_scale, (0, 255, 255), thickness=1)
